...
with cont_1:
    ...
    with outer_cols[1]:
        ...
        with inner_cols[1]:
            ...
            components.html("""<img src="https://raw.githubusercontent.com/celenaaponce/sandbox/main/web_img/Online%20world-cuate%20(2).png" alt="Girl in a jacket">""", height=600, width=500)
