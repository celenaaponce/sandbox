        ...
        with col2:
            if not phone:
                ...
                audio_code = f"""
                            ...
                            """
                html(f'<div onclick="playAudio()" style="cursor: pointer;" height="5"><img id="customImage" src="{image_url}" width="50" style="position: absolute; bottom: 0;"/></div>{audio_code}', height=20)
            else:
                st.audio('bravo1.m4a')
