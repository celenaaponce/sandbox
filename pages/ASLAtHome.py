...
def segunda_semana():
    ...
    with cont_2:
        ...
        with outer_col_2[0]:
            st.markdown("<a href='https://youtu.be/F_TOHsNTfwo'><img src='https://raw.githubusercontent.com/celenaaponce/sandbox/main/Dictionary-amico.png' alt='Vocabulario'/>Vocabulario</a>", unsafe_allow_html=True)
