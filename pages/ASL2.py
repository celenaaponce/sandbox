...
def segunda_semana():
    set_styles()
    tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs(["Introduccion", "Vocabulario y Frases", "Dialogo sin subtitulos", "Dialogo con subtitulos", "Conversacion sin subtitulos", "Conversacion con subtitulos", "Otro"])
    with tab1:
    ...
    with tab2: 
        ...
        with clms3[0]:
          st.title('')
          st.title('')
          st.subheader('Vocabulario y Frases L1')
        with clms3[1]:
        ...
        with clms8[0]:
            st.title('')
            st.title('')
            st.subheader('Vocabulario y Frases L2')
        ...
        with clms20[0]:
          st.title('')
          st.title('')
          st.subheader('Vocabulario y FrasesL4')
        with clms20[1]:
    ...
    with tab3:
        ...
        with clms4[0]:
          st.title('')
          st.title('')
          st.subheader('Diálogo (sin subtítlos) 🔇L1')
        with clms4[1]:
        ...
        with clms9[0]:
            st.title('')
            st.title('')
            st.subheader('Diálogo (sin subtítlos) 🔇L2')  
        with clms9[1]:
        ...
        with clms15[0]:
          st.title('')
          st.title('')
          st.subheader('Diálogo (sin subtítlos) 🔇L3')
        with clms15[1]:
        ...
        with clms22[0]:
          st.title('')
          st.title('')
          st.subheader('Diálogo (sin subtítlos) 🔇L4')
        with clms22[1]:
  ...
  with tab4:      
        ...
        with clms5[0]:
          st.title('')
          st.title('')
          st.subheader('Diálogo (con subtítulos) 🔈L1')
        with clms5[1]:
        ...
        with clms10[0]:
          st.title('')
          st.title('')
          st.subheader('Diálogo (con subtítulos) 🔈L2')
        with clms10[1]:
        ...
        with clms16[0]:
          st.title('')
          st.title('')
          st.subheader('Diálogo (con subtítlos) 🔈L3')
        with clms16[1]:
        ...
        with clms23[0]:
          st.title('')
          st.title('')
          st.subheader('Diálogo (con subtítlos)L4')
        with clms23[1]:
    ...
    with tab5:
        ...
        with clms6[0]:
          st.title('')
          st.title('')
          st.subheader('Conversación (sin subtítulos) 🔇L1')
        with clms6[1]:
        ...
        with clms11[0]:
          st.title('')
          st.title('')
          st.subheader('Conversación (sin subtítulos) 🔇L2')
        with clms11[1]:
        ...
        with clms17[0]:
          st.title('')
          st.title('')
          st.subheader('Conversación (sin subtítulos) 🔇L3')
        with clms17[1]:
        ...
        with clms24[0]:
          st.title('')
          st.title('')
          st.subheader('Conversación (sin subtítulos) 🔇L4')
        with clms24[1]:
    ...
    with tab6:
        ...
        with clms12[0]:
          st.title('')
          st.title('')
          st.subheader('Conversación (con subtítulos) 🔈L2')
        with clms12[1]:
        ...
        with clms18[0]:
          st.title('')
          st.title('')
          st.subheader('Conversación (con subtítulos) 🔈L3')
        with clms18[1]:
        ...
        with clms25[0]:
          st.title('')
          st.title('')
          st.subheader('Conversación (con subtítulos) 🔈L4')
        with clms25[1]:
          st.video('https://youtu.be/qktiKSw2kpQ')
        ...
        with clms7[0]:
          st.title('')
          st.title('')
          st.subheader('Conversación (con subtítulos) 🔈L1')
        with clms7[1]:
