...
def login_sidebar_ASL1():
            ...
            st.sidebar.page_link("pages/helper/Introduccion_a_ASL_1.py", "Introducción a ASL 1")
            st.sidebar.page_link("pages/helper/Bravo_1.py", "Conocer la Familia Bravo")
            st.sidebar.page_link("pages/helper/holidays_spring.py", "Días Festivos")
